...
المطلوب بدقة متناهية وبدون أي تخمين:
1. ⚠️ استمع للصوت واكتب فقط اللوحة التي نطقها المتحدث بدون زيادة أو نقصان. إذا كان هناك صمت تام فقط أرجع مصفوفة فارغة: []
2. ⚠️ تمييز الحروف بدقة صوتية مطلقة:
   - إذا قال المتحدث 'جيم' أو 'ج' اكتب حرف (ج) ولا تحوله إلى حاء أبداً! (مثال: 'أ ب ج 1234').
   - إذا قال المتحدث 'حاء' أو 'ح' اكتب حرف (ح).
   - إذا قال المتحدث 'كاف' اكتب (ك)، وإذا قال 'قاف' اكتب (ق).
   - أمثلة لوحات: 'أ ب ج 1234' ، 'ب أ ط 6153' ، 'ح ن ق 2385' ، 'ك د م 958' ، 'د ب أ 9075'.
3. ⚠️ الأرقام: اكتب جميع الأرقام كاملة (مثال: 'ثلاثة آلاف وخمسمائة وخمسة وسبعين' = 3575 ، 'واحد اثنين ثلاثة أربعة' = 1234).
4. ⚠️ الصيغة القياسية: 3 حروف متباعدة + 1 إلى 4 أرقام (مثال: 'أ ب ج 1234' أو 'ب أ ط 6153').
5. أرجع مصفوفة JSON فقط بالشكل التالي:
[{"plate": "أ ب ج 1234", "found": false, "vehicle_type": "", "notes": ""}]
